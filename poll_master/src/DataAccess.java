...
public class DataAccess {
	public static String testConnection() {
		...
		try {
			...
			ret += "Driver Loaded";
			cn = DriverManager.getConnection("jdbc:mysql://localhost/poll","root","root");
	...
	public static void updatePollMaster(int pollId, String pollMaster) {
		// TODO Auto-generated method stub
		try {
			Connection cn = getConnection();
	...
	public static void activatePoll(String pollMaster) {
		// TODO Auto-generated method stub
		try {
			Connection cn = getConnection();
			java.sql.PreparedStatement st = cn.prepareStatement("insert into active values(" + pollMaster + ");");
